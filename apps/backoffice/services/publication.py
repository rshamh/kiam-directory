...
from apps.accounts.access import can_suspend_listing
from apps.directory.models import AuditLog, PublicationStatus
...
def lift_suspension(practitioner, *, actor, notes: str = ""):
    ...
    from apps.directory.services.verification import recompute
