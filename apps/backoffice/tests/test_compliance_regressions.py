...
from apps.backoffice.services import invites, publication, review
from apps.directory.factories import ClientGroupFactory, PractitionerFactory, ProfessionFactory
...
def test_concern_reports_cannot_be_deleted_from_admin():
    ...
    from apps.directory.models import ConcernReport
