...
def test_an_unknown_address_still_costs_a_hash(client):
    ...
    from apps.accounts.backends import CaseInsensitiveEmailBackend
...
def _sign_in_by_link(client, user):
    from apps.accounts.services import magic_link
...
def test_an_invited_practitioner_starts_with_no_password(admin_user):
    from apps.backoffice.services import invites
