...
from apps.directory.admin import COMPUTED_VERIFICATION_FIELDS
        ...
        for field in COMPUTED_VERIFICATION_FIELDS:
            if field in model_fields:
                assert field in readonly, (
                    ...
                    "apps.directory.services.verification.recompute() and must be read-only."
                )
...
def test_the_recompute_action_derives_rather_than_sets(rf, superadmin):
    ...
    from apps.directory.admin import PractitionerAdmin
