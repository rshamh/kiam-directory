...
def test_one_failing_send_does_not_stop_the_others(user_factory, monkeypatch):
    ...
    real_send_mail = __import__(
        "apps.directory.management.commands.verification_sweep", fromlist=["send_mail"]
    ).send_mail
    ...
    monkeypatch.setattr("apps.directory.management.commands.verification_sweep.send_mail", flaky)
