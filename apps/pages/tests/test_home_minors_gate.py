...
from apps.directory.models import MinorWorkStatus, Practitioner
...
def test_the_two_real_gates_are_still_in_the_source(client):
    ...
    profile = (app / "services" / "profile.py").read_text()
