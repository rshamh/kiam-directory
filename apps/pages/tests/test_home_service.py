...
from apps.directory.factories import PractitionerFactory, PractitionerLocationFactory
...
def test_every_browse_entry_carries_the_keys_the_template_reads(cohort):
    ...
    from apps.directory.factories import SpecialityCategoryFactory, SpecialityFactory
